...
NudyCrossSection::NudyCrossSection( const std::string isoName, const int Aval, const int Zval, const double projectileKE ) : fIsoName(isoName), fTargetA(Aval), fTargetZ(Zval), fProjEnergy(projectileKE) {}

NudyCrossSection::NudyCrossSection( const NudyCrossSection &other ) :
fIsoName(other.fIsoName), fTargetA(other.fTargetA), fTargetZ(other.fTargetZ), fProjEnergy(other.fProjEnergy) {}
