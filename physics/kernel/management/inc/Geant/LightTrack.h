...
private:
  ...
  geant::RngStream_t fStreamIndex = 0;    /** Rng stream index*/
  geant::RngState_s *fRngState = nullptr; /** Rng states */
...
public:
  ...
  LightTrack(const LTrackStatus aTrackStatus, const int aGVcode, const int aGTrackIndex,
             ...
             const double aNintLen, const double aIntLen, const geant::RngStream_t aStreamIndex, 
             geant::RngState_s *state, ExtraInfo *aExtraInfo = 0);
...
public:
  ...
  geant::RngStream_t *fStreamIndexV;          /** Stream index in the last step of the particles */
