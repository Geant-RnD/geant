...
class TestNudy1DetectorConstruction : public geant::UserDetectorConstruction {
public:
  // CTR
  TestNudy1DetectorConstruction(geant::RunManager *runmgr);
  // DTR
  ~TestNudy1DetectorConstruction();
