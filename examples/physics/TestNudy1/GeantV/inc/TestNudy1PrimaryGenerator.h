...
class TestNudy1PrimaryGenerator : public geant::PrimaryGenerator {
public:
  // CTR DTR
  TestNudy1PrimaryGenerator(const TestNudy1DetectorConstruction *det);
  ~TestNudy1PrimaryGenerator();
