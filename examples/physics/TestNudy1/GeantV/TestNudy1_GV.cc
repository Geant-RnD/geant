...
void SetupUserPhysicsList(userapplication::TestNudy1PhysicsList *physlist);
void SetupUserDetector(userapplication::TestNudy1DetectorConstruction *detector);
void SetupUserField(geant::RunManager *runMgr);
void SetupUserPrimaryGenerator(userapplication::TestNudy1PrimaryGenerator *primarygun);
void SetupUserApplication(userapplication::TestNudy1 *app);
...
void help()
{
  printf("\nUsage: runTestNudy1 [OPTIONS] INPUT_FILE\n\n");
...
void SetupUserPhysicsList(userapplication::TestNudy1PhysicsList *physlist)
{
  if (parProcessMSCStepLimit != "") {
    if (parProcessMSCStepLimit == "UseSafety") {
      ...
      std::cerr << " **** ERROR runTestNudy1::SetupUserPhysicsList() \n"
