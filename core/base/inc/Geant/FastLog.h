/* Fast logarithm from vdt library adapted to GeantV
 * this function is equivalent to Geant4 G4Log
 * Changed namespace names, header names, only double precision version
 */
